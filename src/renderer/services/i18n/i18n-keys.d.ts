...
export type I18nKey =
  ...
  | 'conversation.workspace.skillApps.backendLabel'
  | 'conversation.workspace.skillApps.description'
  | 'conversation.workspace.skillApps.empty'
  | 'conversation.workspace.skillApps.emptyDescription'
  | 'conversation.workspace.skillApps.loadFailed'
  | 'conversation.workspace.skillApps.open'
  | 'conversation.workspace.skillApps.openBundle'
  | 'conversation.workspace.skillApps.openBundleFailed'
  | 'conversation.workspace.skillApps.openFailed'
  | 'conversation.workspace.skillApps.refresh'
  | 'conversation.workspace.skillApps.skillLabel'
  | 'conversation.workspace.skillApps.status.available'
  | 'conversation.workspace.skillApps.status.error'
  | 'conversation.workspace.skillApps.status.open'
  | 'conversation.workspace.skillApps.status.running'
  | 'conversation.workspace.skillApps.status.starting'
  | 'conversation.workspace.skillApps.stop'
  | 'conversation.workspace.skillApps.stopFailed'
  | 'conversation.workspace.skillApps.tab'
  | 'conversation.workspace.skillApps.title'
